				...
				if((*secuenceSymbols)[currentPos].symbolNumber == p.current_symbol_Num && rightNeighborSymbolPos != -1 && (*secuenceSymbols)[rightNeighborSymbolPos].symbolNumber == p.next_symbol_Num){
					...
					if(leftNeighborSymbolPos >= 0 && rightNeighborSymbolPos >= 0 && rightNeighborSymbolPos < secuenceSymbols->size() && rightNeighbotSymbolPosPlusOne >= 0 && rightNeighbotSymbolPosPlusOne < secuenceSymbols->size() && (*secuenceSymbols)[rightNeighbotSymbolPosPlusOne].symbolNumber != -1){
						...
						if(got != newHash->end()){
							...
							if(xAPf.last_pair_Pos >= 0 && xAPf.last_pair_Pos < secuenceSymbols->size()){
					...
					//Ay
					if(rightNeighbotSymbolPosPlusOne >= 0 && rightNeighbotSymbolPosPlusOne < secuenceSymbols->size() && (*secuenceSymbols)[currentPos].nextNeighborPair != rightNeighbotSymbolPosPlusOne && (*secuenceSymbols)[rightNeighbotSymbolPosPlusOne].symbolNumber != nonTerminalSymbolNumber){
						Pair Ay;
						...
						//if(rightNeighborSymbolPos != -1 && pfq.next_symbol_Num == (*secuenceSymbols)[rightNeighborSymbolPos].symbolNumber){
							...
							if(got != newHash->end()){
								...
								if(AyPf.last_pair_Pos >= 0 && AyPf.last_pair_Pos < secuenceSymbols->size()){
					...
					//If it's a pair previously replaced, skip it (example, when replacing 3 3 3, second pair begins in i=1, previously replaced in i=0)
					if(rightNeighborSymbolPos >= 0 && rightNeighborSymbolPos < secuenceSymbols->size() && (*secuenceSymbols)[currentPos].symbolNumber == p.current_symbol_Num && (*secuenceSymbols)[rightNeighborSymbolPos].symbolNumber == p.next_symbol_Num){
